...
import {
  ...
  HourglassEmpty, Inbox, Insights, Keyboard, KeyboardDoubleArrowLeft, KeyboardDoubleArrowRight, Label, LightMode, ListAlt, Lock, Mail, Menu, NoteAdd, Notifications, NotificationsNone,
  ...
  TableView, TaskAlt, Timeline, Today, Tune, UploadFile, Videocam, ViewList, ViewModule, Visibility, VisibilityOff,
